...
public class ASPEA2Manager {
    ...
    public ASPEA2Manager(){
        setParameters(ASPEA2Manager.getDefaultParams());
    }
    ...
    public ASPEA2 Create() {
        ...
        return (new ASPEA2Builder(problem, crossover, mutation)).setSelectionOperator(selection).setMaxIterations(maxEvaluations)
                .setPopulationSize(populationSize).setArchiveSize(archiveSize).setAlphaFactor(alphaFactor).build();
    }
